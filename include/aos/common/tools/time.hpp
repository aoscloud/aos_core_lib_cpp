 ...
 */
const auto cTimeStrLength = AOS_TIME_STRING_LENGTH;
...
public:
     ...
     *
     * @result RetWithError<StaticString<cTimeStrLength>>.
     */
    RetWithError<StaticString<cTimeStrLength>> ToString() const
    {
        StaticString<cTimeStrLength> result;
